...
export const StopBtn = ({ language, disabled }) => {
  ...
  switch (language) {
    case 'ja':
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="30" letter-spacing="0em">
    ...
    default: // default to ENGLISH
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="50" letter-spacing="0em">
