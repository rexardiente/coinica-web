...
export const NextBtn = ({ language }) => {
  ...
  switch (language) {
    case 'ja':
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="24" letter-spacing="0em">
          <tspan x="73" y="14.088">&#10;</tspan>
...
export const MainpageBtn = ({ language }) => {
  ...
  switch (language) {
    case 'ja':
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="20" letter-spacing="0em">
...
export const ChangeBtn = ({ language }) => {
  ...
  switch (language) {
    case 'ja':
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="14" letter-spacing="0em">
    ...
    default: // default to ENGLISH
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="Myfont2" font-size="26" letter-spacing="0em">
