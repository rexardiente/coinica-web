                  ...
                  <Col sm={"12"} md={"4"}>
                    <div className={`${styles.settingsSideNav}`}>
                      <div className="text-left">
                        ...
                        <ListGroup>
                          <ListGroup.Item key="btc" style={{ background: 'transparent' }}>
                          ...
                          <ListGroup.Item key="eth" style={{ background: 'transparent' }}>
                            <div className="d-flex justify-content-between align-items-center">
                              <div className="d-flex align-items-center">
                          ...
                          <ListGroup.Item key="usdc" style={{ background: 'transparent' }}>
                            <div className="d-flex justify-content-between align-items-center">
                              <div className="d-flex align-items-center">  
