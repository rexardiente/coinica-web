...
import newBG from "./tempAssets/newbg.png";
import newBtnHome from "./tempAssets/btn_home.png";
import newBtnList from "./tempAssets/btn_list.png";
import newBtnRanking from "./tempAssets/btn_ranking.png";
...
// TEMP ASSETS
export const backgroundImage = newBG;
export const BtnHome = newBtnHome;
export const BtnList = newBtnList;
export const BtnRanking = newBtnRanking;
export const BtnSummon = newBtnSummon;
export const polygon = polygonImg;
export const GhostListModalBg = newGhostListModalBg;

// mainpage
export const GQ_Title = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/gq_title.png`;
export const PlayBtn = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/btn_play.png`;
export const TutorialBtn = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/btn_tutorial.png`;
export const RulesBtn = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/btn_rules.png`;
export const BtnSettings = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/btn_settings.png`;
export const BtnSpecialGhost = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/special_ghost.png`;
// export const backgroundImage = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/background.jpg`;
export const noticeImage = `${ASSETS_URL}/imgs/games/ghost_quest/mainpage/notice_icon.png`;

// header
// export const BtnHome = `${ASSETS_URL}/imgs/games/ghost_quest/header/btn_home.png`;
// export const BtnList = `${ASSETS_URL}/imgs/games/ghost_quest/header/btn_list.png`;
// export const BtnRanking = `${ASSETS_URL}/imgs/games/ghost_quest/header/btn_ranking.png`;
// export const BtnSummon = `${ASSETS_URL}/imgs/games/ghost_quest/header/btn_summon.png`;
...
export const Slide1 = `${ASSETS_URL}/imgs/games/ghost_quest/modals/tutorials/summon.jpg`;
export const Slide2 = `${ASSETS_URL}/imgs/games/ghost_quest/modals/tutorials/summon2.jpg`;
export const Slide3 = `${ASSETS_URL}/imgs/games/ghost_quest/modals/tutorials/inbattle.jpg`;
export const Slide4 = `${ASSETS_URL}/imgs/games/ghost_quest/modals/tutorials/history.jpg`;

// rules
export const Rules_BG = `${ASSETS_URL}/imgs/games/ghost_quest/modals/rules/background.png`;
export const Rules_StatusImg = `${ASSETS_URL}/imgs/games/ghost_quest/modals/rules/status.png`;
export const Rules_RarityImg = `${ASSETS_URL}/imgs/games/ghost_quest/modals/rules/rarity.png`;
export const Rules_HouseEdgeImg = `${ASSETS_URL}/imgs/games/ghost_quest/modals/rules/house_edge.png`;

// settings
export const Settings_BG = `${ASSETS_URL}/imgs/games/ghost_quest/modals/settings/bg_setting.png`;
export const Settings_ToggleOn = `${ASSETS_URL}/imgs/games/ghost_quest/modals/settings/toggle_on.png`;
export const Settings_ToggleOff = `${ASSETS_URL}/imgs/games/ghost_quest/modals/settings/toggle_off.png`;
