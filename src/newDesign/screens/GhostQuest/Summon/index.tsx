...
const Summon = ({
  ...
  const [summonTime, setSummonTime] = useState(0)
  ...
  const gotoConfirm = () => {
    if (summonTime <= 0 || summonTime > 50) {
      toast.warn('Please set your summon time')
      return
    }
  ...
  return (
    <div className={styles.outer}>
      ...
      >
        <img src={Summon_BG} alt="Modal Background" />
        <img
          src={ModalBtnCancel}
          alt="Cancel"
