...
export const GameStartBtn = ({ language, isStarted }) => {
  ...
  switch (language) {
    ...
    default: // default to ENGLISH
      text = (
        <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="TH Primary" font-size="50.2328" letter-spacing="0em">
...
export const WithdrawBtn = ({ language, disabled }) => {
  ...
  return (
    ...
    //   <path fill-rule="evenodd" clip-rule="evenodd" d="M13 43H243V73H13V43Z" fill="#901717"/>
    //   <text fill="#E6D9B0" xmlSpace="preserve" style={{ whiteSpace: "pre" }} font-family="TH Primary" font-size="50.2328" letter-spacing="0em"><tspan x="43" y="60.4285">withdraw</tspan></text>
